...
% vehicle in the same lane (lead car), $D_{rel}$, as well as the relative
% velocity of the lead car, $V_{rel}$. The ACC system operates in the
% following two modes:
%
...
x0_lead = 1500;   % initial position for lead car (m)
